...
2. Create your own scraping scheme and put it into project folder (where this readme.txt is found)
...
Scraper.start(yourScrapingFunction)	// Sets scraping callback function which receives reference to document as parameter and must return an object that
...
DISCLAIMER: Don't do anything illegal with it, respect the law. Use at your own risk and responsibility. No claims of any kind can be made to the author.
